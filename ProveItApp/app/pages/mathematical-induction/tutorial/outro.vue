        ...
        <div class="relative text-center px-4 justify-items-center">
            ...
            <div class="bg-white border-4 border-black rounded-xl p-6 text-left inline-block relative text-lg font-medium mx-auto">
                <p class="">
                    ...
                    Cool right? On the next exercise, you will practice mathematical induction <br />
                    further with my assistance and at the end you will be able<br />
                    to use this method without any help from me.
                </p>
                <!-- Speech bubble tail -->
